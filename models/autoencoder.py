import numpy as np
import models.complex as cp


class AutoEncoder:
    def __init__(self, activation_fn, derived_activation_fn, input_dim, hidden_layer_sizes, latent_dim,
                 use_momentum=False, momentum_alpha=0.9):
        self.input_dim = input_dim
        self.latent_dim = latent_dim

        encoder_layers = hidden_layer_sizes.copy()
        ...
        decoder_layers = hidden_layer_sizes[::-1]
